const PolicyPage = () => {
  return (
    <div className="mt-40 max-w-screen-desktop mx-auto pb-10">
      ...
      <h2 className="text-2xl my-8">Interpretation and Definitions</h2>
      ...
      <div className="flex flex-col space-y-4">
        ...
        <ul className="list-disc ml-8">
          ...
          <li>Website refers to MRO Gulf, accessible from mrogulf.com</li>
          <li>
      ...
      <h2 className="text-2xl my-8">Collecting and Using Your Personal Data</h2>
      <div className="flex flex-col space-y-4">
      ...
      <h1 className="text-3xl my-8">Use of Your Personal Data</h1>
      <div className="flex flex-col space-y-4">
      ...
      <h2 className="text-2xl my-8">Retention of Your Personal Data</h2>
      <div className="flex flex-col space-y-4">
        <p>
      ...
      <h2 className="text-2xl my-8">Transfer of Your Personal Data</h2>
      <div className="flex flex-col space-y-4">
        <p>
      ...
      <h2 className="text-2xl my-8">Delete Your Personal Data</h2>
      <div className="flex flex-col space-y-4">
        <p>
      ...
      <h2 className="text-2xl my-8">Disclosure of Your Personal Data</h2>
      <div className="flex flex-col space-y-4">
      ...
      <h2 className="text-2xl my-8">Security of Your Personal Data</h2>
      <div className="flex flex-col space-y-4">
        <p>
      ...
      <h2 className="text-2xl my-8">Children&apos;s Privacy</h2>
      <div className="flex flex-col space-y-4">
        <p>
      ...
      <h2 className="text-2xl my-8">Links to Other Websites</h2>
      <div className="flex flex-col space-y-4">
        <p>
      ...
      <h2 className="text-2xl my-8">Changes to this Privacy Policy</h2>
      <div className="flex flex-col space-y-4">
        <p>
      ...
      <div className="flex flex-col space-y-4">
        ...
        <ul className="list-disc ml-8">
          <li>By email: assistant@mrogulf.com</li>
        </ul>
      </div>
    </div>
  );
